package com.testsimulation.application.list;
...
public class TestsimulationSimulationPanelApp extends BaseJSPPanelApp {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=testsimulation)",
		unbind = "-"
	)
